...
public class MainActivity extends ActionBarActivity {
	...
	private int wpmrate;			// default words per sec ~= 200wpm
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		TextView ratetxt = (TextView) findViewById(R.id.textView8); // get rate value from view
		Integer rateval = 60; //Integer.parseInt(ratetxt.toString());
		Log.e("onCreate","rate text: "+ rateval); 
		wpmrate = rateval;
	...
	private Runnable updateCounterThread = new Runnable() 
		...
		public void run() {
			...
			Log.e("runninge","words per minute rate: " + wpmrate);
